...
console.log("𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 𝚂𝙷𝙰𝙽𝚄𝚆𝙰 𝙼𝙳 🎭...");
...
console.log('𝚂𝙷𝙰𝙽𝚄𝚆𝙰 𝙼𝙳 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚃𝙾 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙴𝙽𝙹𝙾𝚈 ✅')

let up = `>  *Hᴇʟʟᴏ ᴛʜᴇʀᴇ ꜱʜᴀɴᴜᴡᴀ ᴍᴅ ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 

*ශනුක හදපු බොට් තමා අලේ මේ 💗😙✨* 

*බොට් වැඩද කියලා ᴛᴇxᴛ කරන්න .menu කියලා ගහල බලන්න අලේ 💥

> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱʜᴀɴᴜᴋᴀ ꜱʜᴀᴍᴇᴇɴ`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/FbG8tM5t/9-FLp8dz-Kr-R.jpg` }, caption: up })
...
//================ownerreact
if(senderNumber.includes("94785871303")){
if(isReact) return
m.react("👨‍💻")
}

if(senderNumber.includes("94764521507")){
if(isReact) return
m.react("👨‍💻")
       }
...
app.get("/", (req, res) => {
res.send("𝚂𝙷𝙰𝙽𝚄𝚆𝙰 𝙼𝙳 IS 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 ✅");
});
